(() => {
  ...
  [
    './filter-scroll.css?v=35',
    './compact-nav.css?v=35',
    './city-list-fix.css?v=35'
  ].forEach(href => {
  ...
  if (!document.querySelector('script[data-multicity]')) {
    const openTag = '<scr' + 'ipt src="./multicity.js?v=35" data-multicity="true">';
  ...
  window.addEventListener('load', () => {
    ...
    script.src = './compact-search.js?v=35';
