(() => {
  ...
  [
    './filter-scroll.css?v=34',
    './compact-nav.css?v=34',
    './city-list-fix.css?v=34'
  ].forEach(href => {
  ...
  if (!document.querySelector('script[data-multicity]')) {
    const openTag = '<scr' + 'ipt src="./multicity.js?v=34" data-multicity="true">';
  ...
  window.addEventListener('load', () => {
    ...
    script.src = './compact-search.js?v=34';
